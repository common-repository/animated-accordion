...
$animated_Accordion_panels_content = $wpdb->get_results("SELECT * FROM $table_name_animated_Accordion_content WHERE id_ata_id=$ata_id");
?>
...
<div class="wrap">
    ...
    <div style="float:left;position:relative;left:50px;width:200px">
        <button class="btn btn-success" style="margin-top: 10px;" type="submit" id="submit" name="submit">Save Accordion</button>
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left" style="padding-top:80px;">
        ...
        <input type="hidden" name="aaction" id="aaction" value="add"/>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Animated Accordion Name: 
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="aName" id="aName" value="<?php echo $animated_Accordion_Name ?>"  class="form-control col-md-7 col-xs-12">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="title">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="aTitle" id="aTitle" value=""  class="form-control col-md-7 col-xs-12">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" >
                            <input type="text" name="titleBorderWidth" id="titleBorderWidth"
                                   placeholder="width" value="<?php echo $panel->titleBorderWidth; ?>"  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="titleBorderColor" id="titleBorderColor" value="<?php echo $panel->titleBorderColor; ?>"  class="cpa-color-picker  form-control col-md-7 col-xs-12">
                ...
                <div class="tab-pane fade" id="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" >
                            <input type="text" name="contentBorderWidth" id="contentBorderWidth"
                                   placeholder="width" value="<?php echo $panel->contentBorderWidth ?>"  
                                   class="form-control col-md-7 col-xs-12" style="width: 80px;">&nbsp;px
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="contentBorderColor" id="contentBorderColor" value="<?php echo $panel->contentBorderColor ?>"  class="cpa-color-picker  form-control col-md-7 col-xs-12">
                ...
                <div class="tab-pane fade" id="image">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="aImage" id="aImage" value="<?php echo $results[1] ?>"  class="regular-text form-control col-md-7 col-xs-12">
